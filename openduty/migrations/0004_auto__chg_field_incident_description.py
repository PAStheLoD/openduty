...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('openduty_incident', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Incident.description'
        db.alter_column('openduty_incident', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))
