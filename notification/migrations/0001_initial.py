...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('notification', ['UserNotificationMethod'])
        ...
        db.send_create_signal('notification', ['ScheduledNotification'])
    ...
    models = {
        ...
        'notification.schedulednotification': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'incident': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['openduty.Incident']"}),
            'message': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'notifier': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'send_at': ('django.db.models.fields.DateTimeField', [], {}),
            'user_to_notify': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'notification.usernotificationmethod': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notification_methods'", 'to': "orm['auth.User']"})
        },
        'openduty.incident': {
